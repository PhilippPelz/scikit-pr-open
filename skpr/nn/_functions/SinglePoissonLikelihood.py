...
class SinglePoissonLikelihood(Function):
    @staticmethod
    def forward(ctx, I_model, I_target, valid_mask):
        ...
        io.logger.debug('SinglePoissonLikelihood out = %3.2g' % out[0])
        return out.cpu()

    @staticmethod
    def backward(ctx, grad_output):
        io.logger.debug('SinglePoissonLikelihood backward 1')
        ...
        io.logger.debug('SinglePoissonLikelihood backward 3')
