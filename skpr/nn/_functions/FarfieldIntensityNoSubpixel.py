...
class FarFieldIntensityNoSubpixel(Function):
    @staticmethod
    ...
    def backward(ctx, grad_output):
        ...
        # x = np.fft.fftshift(grad_input.cpu().numpy()[:, 0, 0, :, :],(1,2))
        # p.var['grad_exit_wave_f'] = x
        ...
        # x = grad_input.cpu().numpy()[:, 0, 0, :, :]
        # p.var['grad_exit_wave'] = x
