...
class FarFieldAmplitude(Function):
    @staticmethod
    ...
    def backward(ctx, grad_output):
        ...
        """
        io.logger.debug('FarFieldAmplitude backward 1')
        ...
        io.logger.debug('FarFieldAmplitude backward 2')
        ...
        io.logger.debug('FarFieldAmplitude backward 3')
