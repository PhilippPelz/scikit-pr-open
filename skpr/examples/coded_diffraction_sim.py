...
from skpr.core.models import SimFarfieldCodedMeasurementNet
from skpr.core.parameters import *
from skpr.inout.h5rw import h5write
from skpr.inout.plot import plotmosaic
from skpr.nn import modules as M
from skpr.util import *

p = get_default_parameters()

im = rgb2gray(imread(os.getcwd() + '/data/logo.jpg')) + 0j

p.model = SimFarfieldCodedMeasurementNet

p.object.solution = th.from_numpy(im.astype(np.complex64))
...
p.y = th.Tensor(10, im.shape[0], im.shape[1])
...
m = eng.model.coded_measurements.m.cpu().numpy()

print type(I)
h5write('/home/pelzphil/projects/cd_sim.h5', m=m, ob=im, I=I)
