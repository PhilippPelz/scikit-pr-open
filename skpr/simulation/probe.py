...
def focused_probe(E, N, d, alpha_rad, defocus_nm,det_pix = 40e-6, C3_um = 1000, C5_mm=1, tx = 0,ty =0, Nedge = 15, aperture=True, plot=False):
...
#N=128
#r,i = focused_probe(300e3, N, d = 0.85, alpha_rad=7.3e-3, defocus_nm = 4e2, det_pix = 28*5e-6, C3_um = 0, C5_mm=0, \
#                     tx = 0,ty =0, Nedge = 1, plot=True)
#pr = r+1j*i
